...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_znilmng",   // 👈 replace with your EmailJS service ID
        "template_g2yfn1n",  // 👈 replace with your EmailJS template ID
        form.current,
        "XPiKsNTENVbANwPWi"    // 👈 replace with your EmailJS public key
      )
      .then(
        () => {
          setStatus("success");
                  ...
                  <div className="contact-form__row">
                    ...
                    <div className="contact-field">
                      ...
                      <input
                        type="email"
                        name="user_email"
                        placeholder="sanglikarkeyur@gmail.com"
                        required
                      />
                    </div>
                  </div>
