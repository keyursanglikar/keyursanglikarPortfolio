...
const experiences = [
  ...
  "Node.js", "Express.js", "Python", "Flask", "Django", "Java", 
  "Servlet", "JDBC", "Spring", "Spring Boot", "PHP",
  
  // Databases
  "SQL", "MongoDB", "MySQL",
  
  // Frameworks & Patterns
  "MVC", "MERN Stack", "REST API", "JWT Authentication",
  
  // Design & CMS
  "Tailwind CSS", "Three.js", "Framer Motion", "WordPress", "UI/UX",
  
  // Libraries & Tools
  "Redux", "Context API", "Socket.io", "Chart.js",
  
  // Development Practices
  "Full Stack Development", "API Integration", "Database Design", 
  "Version Control", "Git & GitHub", "Deployment"
],
