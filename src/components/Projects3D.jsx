...
const projects = [
  {
    id: 1,
    title: "Anant Exam System with Dashboard",
    category: "EdTech",
    tech: ["C#", ".NET", "SQL", "React", "Node.js", "HTML5", "CSS3", "JavaScript"],
    desc: "Complete examination management platform with student registration, online test creation, real-time result calculation, dashboard analytics, and performance tracking system.",
    color: "#9b59b6",
    year: "2024",
    lines: 11200,
  },
  {
    id: 2,
    title: "RameshWaran Website",
    category: "Frontend",
    tech: ["React", "HTML5", "CSS3", "JavaScript", "Responsive Design"],
    desc: "Modern business website with responsive design, interactive components, and smooth user experience built with React framework.",
    color: "#0abde3",
    year: "2024",
    lines: 3200,
  },
  {
    id: 3,
    title: "Kavitanchgaav Jakatwadi Website",
    category: "Frontend",
    tech: ["React", "HTML5", "CSS3", "JavaScript", "Responsive Design"],
    desc: "Cultural village website showcasing local heritage with interactive UI components and mobile-responsive layout.",
    color: "#10ac84",
    year: "2024",
    lines: 2800,
  },
  {
    id: 4,
    title: "Samarth Tours & Travels Website",
    category: "Frontend",
    tech: ["React", "HTML5", "CSS3", "JavaScript", "Responsive Design"],
    desc: "Travel agency website featuring tour packages, booking interface, destination gallery, and contact management system.",
    color: "#f368e0",
    year: "2024",
    lines: 3500,
  },
  {
    ...
    category: "Full Stack",
    tech: ["React", "Node.js", "MongoDB", "Express", "CSS3", "JavaScript"],
    desc: "Comprehensive blood bank management system with donor registration, inventory tracking, blood request handling, real-time availability updates, and emergency alerts.",
    color: "#ff4757",
    year: "2024",
    lines: 4500,
  },
  {
    id: 6,
    title: "Panchayat Samiti Satara Website",
    category: "Government Portal",
    tech: ["PHP", "HTML5", "CSS3", "JavaScript", "MySQL"],
    desc: "Official panchayat samiti web portal with citizen services, grievance redressal, digital document management, village information system, and public notice board.",
    color: "#f39c12",
    year: "2024",
    lines: 8500,
  },
  {
    ...
    tech: ["Python", "Django", "Flask", "HTML5", "CSS3", "JavaScript"],
    desc: "AI-powered signature verification system with image processing, feature extraction, pattern matching, and user authentication interface.",
    color: "#e84393",
    year: "2024",
    lines: 6800,
  },
      ...
      <div className="projects-inner">
        ...
        <div className={`projects-header${sectionInView ? " visible" : ""}`}>
          <div className="projects-label-row">
            ...
            <span className="projects-label-count">0{projects.length} Projects</span>
          </div>
