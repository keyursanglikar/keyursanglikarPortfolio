  ...
  const rolesData = [
    {
      title: "Full Stack Developer",
      desc: "I build complete web applications from frontend to backend using modern technologies like React, Node.js, and databases.",
      icon: <img src={reactIcon} alt="React" style={{ width: '30px', height: '30px' }} />,
              ...
              <div className="card">
                ...
                <div className="card-content">
                  <div className="role-header">
                    ...
                    <span className="chip"><img className="active-svg" alt="active" src={activeIcon}></img> ACTIVE ROLE</span>
                  </div>
