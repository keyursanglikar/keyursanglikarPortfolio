                ...
                <div className="card-content">
                  ...
                  <div className="education-section">
                    <p className="education-item">
                      ...
                      <span className="text">Degree in Computer Science Engineering</span>
                      <span className="text">Year :- 2024</span>
                    </p>
                    <p className="education-item">
                      <span className="emoji">📚</span>
                      <span className="text">Diploma in Electronics and Telecommunication Engineering</span>
                          <span className="text">Year :- 2021</span>
                    </p>
                    <p className="education-item">
                      <span className="emoji">🏆</span>
                      <span className="text">12th Science </span>
                          <span className="text">Year :- 2019</span>
                    </p>
                    <p className="education-item">
                      <span className="emoji">⭐</span>
                      <span className="text">10th </span>
                          <span className="text">Year :- 2017</span>
                    </p>
                  </div>
