...
const projects = [
  {
    ...
    desc: "Blood bank management system built with React — inventory tracking, donor management, and request handling for blood banks.",
    color: "#ff4757",
    year: "2024",
    lines: 4200,
  },
  {
    ...
    desc: "Modern, responsive landing page with smooth animations and clean UI/UX design principles.",
    color: "#0abde3",
    year: "2024",
    lines: 1800,
  },
  {
    ...
    desc: "Feature-rich task management web app with create, read, update, delete operations and persistent local storage.",
    color: "#10ac84",
    year: "2024",
    lines: 950,
  },
  {
    ...
    desc: "Dual-function time utility featuring precise stopwatch with lap tracking and countdown timer with alerts.",
    color: "#f368e0",
    year: "2024",
    lines: 850,
  },
