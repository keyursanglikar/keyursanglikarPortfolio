...
const projects = [
  {
    ...
    longDesc: "Built a complete MERN stack application with JWT authentication, MongoDB database, and responsive UI. Features include user profiles, post creation, comments, and real-time notifications. Implemented Redux for state management and Socket.io for real-time updates.",
  ...
  },
  {
    ...
    longDesc: "Enterprise-level backend system built with Java and JDBC. Implements multi-threading for concurrent processing, connection pooling, and optimized SQL queries for high performance. Includes caching mechanisms and REST API endpoints.",
  ...
  },
  {
    ...
    longDesc: "Modern portfolio website featuring 3D models, smooth animations, and interactive UI components. Built with React and Three.js for an engaging user experience. Includes particle effects, parallax scrolling, and dynamic content loading.",
  ...
  },
  {
    ...
    longDesc: "Comprehensive automation tool with user-friendly GUI. Handles web scraping, data processing, file operations, and scheduled tasks automatically. Includes email notifications, logging, and error handling.",
...
function Projects3D() {
  ...
  const handlePageFlip = () => {
    ...
    flipSound.play().catch(e => console.log('Audio not loaded'));
  ...
  const handleNext = () => {
    if (currentPage < projects.length - 1 && !isReaching) {
      ...
      setTimeout(() => {
        ...
        // Trigger page flip animation on card
        if (cardRef.current) {
