...
/* ── Tech stack pills ── */
const skills = ["Html5", "Css3","JavaScript","TypeScript","React", "Node.js", "ExpressJs", "MongoDb", "Java", "Jdbc","Servlet","Maven","Spring","Springboot" ,"Python","Flask" ,"Django", "SQL"];

/* ── Social / contact data ── */
const contacts = [
  {
    label: "sanglikarkeyur@gmail.com",
    href: "https://mail.google.com/mail/?view=cm&fs=1&to=sanglikarkeyur@gmail.com",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/keyur-sanglikar?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="hero-content">
          ...
          <div className="hero-edu">
            <div className="hero-edu__item">
              ...
              <span className="hero-edu__degree">B.Tech In Computer Science Engineering</span>
            </div>
            <div className="hero-edu__item">
              <span className="hero-edu__year">2021</span>
              <span className="hero-edu__degree">Diploma in Electronics & Telecommunicatin Engineering</span>
            </div>
          </div>
