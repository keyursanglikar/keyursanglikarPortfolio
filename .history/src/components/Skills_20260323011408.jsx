...
//     color: "rgba(135deg, #0011ff, #ff0a0a)",
...
// Create a styled Java icon with gradient
const JavaIconWithGradient = () => (
  <FaJava 
    className="skill-icon java-icon" 
    style={{
      background: "linear-gradient(135deg, #0011ff, #ff0a0a)",
...
const skills = [
  { 
    name: "Java", 
    level: "Advanced",
    icon: <JavaIconWithGradient />, // Use the component with gradient
    color: "#0011ff"
  },
  { 
    name: "React JS", 
