...
const experiences = [
  ...
  },
  {
    ...
    type: "Full Time Job",
    skills: ["MongoDB", "Express", "React", "Node.js","DotNet","Sql","Html5","Css3","JavaScript","C#"],
  ...
  },
  {
    ...
    type: "Freelance",
    skills: {
  "Frontend": ["HTML5", "CSS3", "JavaScript", "React.js", "Next.js", "TypeScript", "Tailwind CSS", "Three.js", "Framer Motion", "Redux", "Context API"],
  "Backend": ["Node.js", "Express.js", "Python", "Flask", "Django", "Java", "Servlet", "JDBC", "Spring", "Spring Boot", "PHP", "REST API", "JWT"],
  "Database": ["SQL", "MongoDB", "MySQL"],
  "Frameworks & Architecture": ["MVC", "MERN Stack", "Spring Boot"],
  "CMS & Design": ["WordPress", "UI/UX"],
  "Tools & Others": ["Deployment", "Git & GitHub", "API Integration", "Database Design", "Version Control", "Socket.io", "Chart.js"]
},
