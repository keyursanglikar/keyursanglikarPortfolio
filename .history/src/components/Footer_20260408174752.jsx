      ...
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div className="footer-social">
            ...
            <div className="footer-icons">
              ...
              <a href="https://www.linkedin.com/in/keyur-sanglikar?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="footer-icon-btn" aria-label="LinkedIn">
                <FaLinkedinIn size={20} />
              </a>
              {/* <a href="https://twitter.com" target="_blank" rel="noreferrer" className="footer-icon-btn" aria-label="Twitter">
                <FaTwitter size={20} />
              </a> */}
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sanglikarkeyur@gmail.com" className="footer-icon-btn" aria-label="Email">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <span className="footer-mono">Copyright © 2026</span> All rights reserved. 
            Designed & Developed By Softgenix IT Solutions <span className="footer-heart"></span>
          </div>
