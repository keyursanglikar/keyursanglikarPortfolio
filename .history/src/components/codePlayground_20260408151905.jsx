...
const generateOutputHTML = useCallback(() => {
  if (currentLanguage === "react") {
    // Fix React output with proper Babel configuration
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <script type="text/babel" data-presets="react">
    ...
    // Fix for React 18 createRoot
    const rootElement = document.getElementById('root');
    
    ${jsxCode.includes('export default') ? jsxCode.replace('export default', 'const App =') : jsxCode}
    
    // Render the app
    const AppComponent = typeof App !== 'undefined' ? App : (${jsxCode.match(/function\s+(\w+)/)?.[1] || 'App'});
